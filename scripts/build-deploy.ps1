...
=============================================================
 ...
 Вход в интерфейс ОТКЛЮЧЁН (AUTH_ENABLED=false в .env): система открыта
 всем, кто дотянулся до её порта. Допустимо только в закрытом контуре.

 Чтобы включить вход — поставьте AUTH_ENABLED=true в .env и перезапустите:
   логин:  admin
