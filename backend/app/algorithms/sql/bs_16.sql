...
-- Источник: AFM_2_6.AFM_2_6_9 — ответы юридических лиц на запросы
-- уполномоченного органа по своим бенефициарным собственникам.
-- Результат: AFM_6_TEST.AFM_6_1_22
--
-- Если ЮЛ ответило на запрос по своему бенефициарному собственнику, этому
-- бенефициару присваивается статус «Предполагаемый БС».
-- ============================================================================
...
SELECT * FROM (
    ...
    ) c ON a.taxpayer_iin_bin = c.taxpayer_iin_bin
);
