...
SOURCES: List[DataSource] = [
    ...
    DataSource(
        ...
        tables=[
            ...
            "AFM_2_1.AFM_2_1_22_2021",
        ],
        algorithms=["БС-16", "БС-17"],
        note=(
            "Если заявление подано ЮЛ, конечный бенефициар устанавливается "
            "по регистрационным алгоритмам. БС-16 дополнительно берёт форму 240, "
            "БС-17 учитывает данные КГД по нерезидентам."
        ),
    ),
    DataSource(
        key="КГД_нерезидент",
